          ...
          <section className="glass rounded-3xl p-8 flex flex-col items-center relative overflow-hidden">
            ...
            <div className="w-full space-y-6">
              <div className="space-y-3">
                <label className="text-sm font-medium text-slate-400">Prediction</label>
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm text-slate-400">
                  ...
                  <span className="text-white font-bold">{bet} pts</span>
                </div>
                <input 
                  type="range" min="1" max={Math.max(100, stats.points)} step="1"
              ...
              <button
                disabled={isFlipping || !prediction || stats.points < bet}
                onClick={handlePlay}
                    ...
                    <tr key={r.id} className="hover:bg-slate-800/30 transition">
                      ...
                      <td className="px-4 py-3">
                        <div className="w-12 h-1.5 bg-slate-800 rounded-full overflow-hidden">
                          <div className="h-full bg-blue-500" style={{ width: `${r.confidence}%` }}></div>
                        </div>
                      </td>
